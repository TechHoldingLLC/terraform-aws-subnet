locals {
  ...
  public_subnet_ipv6_cidr_blocks    = [for subnet in aws_subnet.public_subnet_dual_stack : subnet.ipv6_cidr_block]
  ...
  private_subnet_ipv6_cidr_blocks   = [for subnet in aws_subnet.private_subnet_dual_stack : subnet.ipv6_cidr_block]
}